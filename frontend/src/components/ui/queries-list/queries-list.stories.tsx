...
const meta: Meta<typeof ListQueriesUI> = {
  ...
  title: 'Components/ui/ListQueriesUI',
  parameters: {
    layout: 'centered',
...
export const WithManyTexts: Story = {
  args: {
    title: 'История',
    listQueries:[
      {name:'ткани ткани ткани ткани ткани ткани ткани ткани ткани', id:'1', path:''}, 
      {name: 'шторы шторы шторы шторы шторы шторы шторы шторы шторы шторы',  id:'2', path:''}, 
      {name:'распродажа распродажа распродажа распродажа распродажа распродажа распродажаs',  id:'3', path:''}
    ],
    isShow: true,
    onDelete: ()=> alert('Вы удалили запрос'),
    onClearList: ()=>alert('Вы очистили историю')
