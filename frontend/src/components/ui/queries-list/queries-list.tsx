 ...
 return (
     <div className={clsx(styles.queries, isShow &&  styles.queriesOpened)}>
            <div className={styles.queryHeader}>
              ...
              {
                onClearList &&  <button onClick={onClearList} className={styles.queriesBtn}>очистить</button>
              }
            </div>
                  ...
                  <li key={query.id} className={styles.query}>
                   <Link to={`/${query.path}`} className={styles.queryLink}>
                    ...
                    <div className={styles.qeryIconWrapper}>
                      <IconButtonUI sizeIcon={13} onClick={()=>onDelete?.(query.id)} isActive={false} iconClass={'close'} />
                    </div>
                   </li>
                ))
              }
